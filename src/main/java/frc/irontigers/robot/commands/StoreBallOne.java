...
public class StoreBallOne extends StateTransitionCommand<BallStates> {
  ...
  public StoreBallOne(Magazine magazine, Shooter shooter, Intake intake) {
    ...
    addNextState(new BallStates(PositionState.UNKNOWN, PositionState.EMPTY, PositionState.RIGHT, PositionState.EMPTY), new ReadColorCommand(magazine, shooter, intake));
