...
public class RejectBallTwo extends StateTransitionCommand<BallStates> {
  ...
  public RejectBallTwo(Magazine magazine, Intake intake, Shooter shooter) {
    ...
    addCommands(
      ...
      addNextState(new BallStates(PositionState.EMPTY, PositionState.RIGHT, PositionState.EMPTY, PositionState.EMPTY), new ReadColorCommand(magazine, shooter, intake));
